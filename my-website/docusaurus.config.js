...
const config = {
  title: 'Course project', //Название сайта на начальной странице
  tagline: 'About course project', // Описание сайта на начальной странице
  favicon: 'img/favicon.ico', // Иконка сайта
  url: 'https://nstsai.github.io/', // Адрес gitlab pages, обычно https://<username>.github.io
  baseUrl: 'SAproject', // Базовый url, обычно название репозитория
  organizationName: 'nstsai', // Имя GitHub пользователя
  projectName: 'SAproject', // Имя репозитория
    ...
    [
      ...
      ({
        docs: {
          ...
          routeBasePath: 'docs',
          editUrl:
            'https://github.com/nstsai/SAproject',
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          {
            href: 'https://github.com/nstsai/SAproject',
            label: 'GitHub',
            position: 'right',
          },
        ],
